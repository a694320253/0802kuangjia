...
import com.huitu.alyssachia.utils.LogUtils;
...
public class PersistentCookieStore implements CookieStore {
    ...
    protected String encodeCookie(SerializableHttpCookie cookie) {
        ...
        try {
            ...
            LogUtils.debug(LOG_TAG, "IOException in encodeCookie" + e.toString());
            return null;
        }
    ...
    protected HttpCookie decodeCookie(String cookieString) {
        ...
        try {
            ...
            LogUtils.debug(LOG_TAG, "IOException in decodeCookie" + e.toString());
        } catch (ClassNotFoundException e) {
            LogUtils.debug(LOG_TAG, "ClassNotFoundException in decodeCookie" + e.toString());
        }
